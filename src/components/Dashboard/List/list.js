...
// taking  coin, delay, isWatchlistPage : from tabs components
    ...
    <a href={`/coin/${coin.id}`}>
      ...
      >
        ...
        <Tooltip placement="bottom-start" title="Market Cap">
          ...
          {/* passing coin.market_cap  to function convertNumbers() */}
...
//Tooltip : gives a  text when hover over a particular component { title = "Market Cap"}
